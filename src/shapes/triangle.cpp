...
{  
    ...
    */
    ...
    else
    {
        ...
        cout << "-- Medians --\n\n";
        cout << "Median from A to midpoint of BC: (" << tX << ", " << tY << ")\n";
        cout << "Median from B to midpoint of AC: (" << sX << ", " << sY << ")\n";
        cout << "Median from C to midpoint of AB: (" << rX << ", " << rY << ")\n\n";

        cout << "-- Triangle Centers --\n\n";
        cout << "Incenter: (" << Ix << ", " << Iy << ")\n";
        cout << "Centroid: (" << xg << ", " << yg << ")\n";      
